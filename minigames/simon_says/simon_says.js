var initWidgets = function () {
	...
	var wall = widgets.createWall(new THREE.Vector3(0, -200, 0), new THREE.Vector3(500, 10, 300));
	var redButton = widgets.createButton("Decrease", new THREE.Vector3(-100, -100, 0), new THREE.Vector3(100, 70, 30));
	var blueButton = widgets.createButton("Increase", new THREE.Vector3(100, -100, 0), new THREE.Vector3(100, 70, 30));
	redButton.addEventListener('press', function(evt) {
		counterLabel.setText(parseInt(counterLabel.getText())-1);
	});
	blueButton.addEventListener('press', function(evt) {
		counterLabel.setText(parseInt(counterLabel.getText())+1);
	});
	...
	spotLight.position.fromArray([wall.position.x, wall.position.y + 1000, wall.position.z]);
	...
	window.camera.position.fromArray([0, 300, 0]);
	window.camera.lookAt(new THREE.Vector3(0, redButton.position.y, redButton.position.z));
